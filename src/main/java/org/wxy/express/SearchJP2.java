...
public class SearchJP2 extends JPanel implements ActionListener,MouseListener,ChangeListener {
	private static final Logger logger = LoggerFactory.getLogger(SearchJP2.class);
